...
Given("select {string} date from {string} homepage calendar", (date: string, datePicker: string) => {
...
Then("enter YYYYMMDD date {string} in the {string} field", (dateString: string, locator: string) => {
...
Then("enter yesterday YYYYMMDD date in the {string} field", (locator: string) => {
  const formattedDate = DateInputHelper.getRelativeDate(-1);
  DateInputHelper.setDateInField(locator, formattedDate);
});

Then("enter tomorrow YYYYMMDD date in the {string} field", (locator: string) => {
  const formattedDate = DateInputHelper.getRelativeDate(1);
  DateInputHelper.setDateInField(locator, formattedDate);
});
